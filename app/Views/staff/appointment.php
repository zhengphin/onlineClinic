            ...
            <div class="booking-form card p-3 bg-info">
               ...
               <form action="<?=base_url('Appointment/createAppointment');?>" method="post">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6" id="servicestype"  style="display: block">
                        <div class="form-group">
                  ...
                  <div class="form-group">
                  <input type="hidden" value="<?=$patientkey?>" name="addAppPatientID"/>
                     <input type="submit" name="submitAppointment" value="Submit" class="btn btn-warning">
                  </div>
               </form>
            </div>
         </div>
