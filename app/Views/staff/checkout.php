                  ...
                  <table class="table table-bordered">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                           <button id="viewPanel" style="margin:2px;" class="btn btn-info launch" value="<?=getPatientInfoByEmail($row['patientkey'],'name')?>"  onclick="speech('<?=getPatientInfoByEmail($row['patientkey'],'name')?>')">Notify</button>
                           <form action="<?= route_to('staff.toCheckout'); ?>" method="post" target="_blank">
                           <input type="hidden" name="queueID" value="<?=$row['key']?>"/>
                           <button id="toBilling" type="submit" style="margin:2px;"  class="btn btn-warning launch" >Prepare Medicine</button>
                           </form>
...
function speech(value) {
  ...
  var appenText=" please go to counter to take your prescription";
