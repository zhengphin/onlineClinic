          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">Create At: <?=$userInfo['createdDate']?></p>
                <div class="form-group">
              
            <form enctype="multipart/form-data" action="<?=base_url('PatientDash/uploadImage');?>" method="post">
        ...
        <input  type="submit" class="btn btn-primary btn-block"  value="upload">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Appointment</b> <a class="float-right"><?=countRecord('appointment','user',$userInfo['email'])?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Payment</b> <a class="float-right">2</a>
                  </li>
                  <li class="list-group-item">
                    <b>Laboratory Report</b> <a class="float-right">3</a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                tab-pane" id="settings">
                  <form class="form-horizontal" action="<?=route_to('patient.updateProfile');?>" method="post">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputaddress"  name="address"  placeholder="home address" value="<?=$userInfo['address']?>">
                          <?php if(!empty(session()->getFlashdata('addressError'))):?>
                        <div class="text-danger"><?= session()->getFlashdata('addressError');?></div>
                          <?php endif ?>                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Postcode </label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputpostcode"  name="postcode"  placeholder="Post Code" value="<?=$userInfo['postCode']?>">
                  ...
                  tab-pane" id="change">
                  <form class="form-horizontal" action="<?=route_to('patient.updatePassword');?>" method="post">
                      <div class="form-group row">
...
function ajaxRequest(url){
  $.ajax({
    url:"<?=site_url('handle-myajax')?>",//current url
    type:"POST",
    data:{
      name:url.toString(),
      key:"<?=$userInfo['key']?>",
