...
">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Mendidik 18 JAM</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url('admin/manage');?>" class="nav-link 
            <?=(current_url()==base_url('admin/manage'))?'active':'';?>">
          ...
          <li class="nav-item">
            ...
            <?=(current_url()==base_url('admin/logout'))?'active':'';?>">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url('admin/manage');?>">Home</a></li>
