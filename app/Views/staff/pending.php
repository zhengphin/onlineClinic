         ...
         <?php if(!empty(session()->getFlashdata('fail'))):?>
            ...
            <div class="table-wrapper">
               <div class="table-title">
                  <div class="row">
                     <div class="col-sm-4">
                        <h2>Pending <b>Appointment</b></h2>
                     </div>
                     <div class="col-sm-8   ">						
                        <a href="<?=route_to('staff.pending');?>" class="btn btn-primary"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-sm-2">
                        <div class="show-entries">
                           <form action="<?=route_to('staff.pending');?>" method="post">
               ...
               <table class="table table-striped table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><span class="status text-warning">&bull;</span><?php echo $row['status'];?></td>
               ...
               <div class="clearfix">
                  ...
                  <ul class="pagination justify-content-center">
                     <li class="page-item <?php if($page <= 1){ echo 'disabled'; } ?>">
                        <a class="page-link"
                           ...
                           <?php if($page <= 1){ echo '#'; }
                                 ...
                                 echo base_url('staff/pending?page=').$prev;
                     ...
                     <li class="page-item <?php if($page == $i) {echo 'active'; } ?>">
                        <a class="page-link" href="<?=base_url('staff/pending');?>?page=<?= $i; ?>"> <?= $i; ?> </a>
                     </li>
                     <?php endfor; ?>
                        ...
                        <a class="page-link"
                           ...
                           <?php
                              ...
                              { echo '#'; } 
                               ...
                               echo base_url('staff/pending?page='). $next; } ?>">Next</a>
                     </li>
                  </ul>
               </div>
            </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  ...
                  <p class="status2"><strong> Status: </strong><span style="color:white; background:orange;">Pending</span></p>
