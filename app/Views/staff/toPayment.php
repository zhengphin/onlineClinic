   ...
   <div class="container-fluid text-black mt-4" style="background-color:white;">
      ...
      <div class="table-wrapper">
               ...
               <table class="table table-striped table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="#deleteEmployeeModal" id="deletebtn" data-id="<?= $row['key'];?>"  class="delete" data-toggle="modal"><span style="color:red;">Delete</span></a>
                        </td>
                     </tr>
                  ...
                  <div style="float:right;">Total Price: RM<?php 
                  if(isset($subtotal2)){
                  echo $subtotal;   
                  }?></div>
...
<br>
   ...
   <div class="container-fluid text-black mt-2" style="background-color:white;">
      <h4><u>Payment</u></h4>
      <div class="row mt-3">
         <div class="col-sm-6">Order Item Price :RM<?=$subtotal?></div>
      </div>
      <div class="row mt-3">
      <div class="col-sm-6">Service Charge&nbsp;&nbsp;&nbsp;&nbsp;:RM<?php if(isset($subtotal2)){
                  echo $subtotal2;   
                  }?></div>
      </div>
      <hr class="bg-danger">
      ...
      <div class="row mt-3">
        <?php
         if(isset($subtotal2)){
            $grand=$subtotal+$subtotal2;  
            }else{
               $grand=$subtotal;
            }
        ?>
         <div class="col-sm-6">Grant Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:RM<?=$grand?></div>
      </div>
      <div class="row mt-3">
         <div class="col-sm-6">

         <form class="form-horizontal" action="<?= route_to('staff.pay');?>" method="post">
                  <div class="form-group">
                    <label>Cash Received</label>
                     <div class="col-sm-10">
                     <input type="hidden"  name="grant" value="<?=$grand?>"/>

                        <input type="number"  step="0.01" name="value1" id="value1" class="form-control" min="<?=$grand?>" placeholder="Enter cash received" required />
                     </div>
                  </div>
         ...
         <div class="form-group">
                       <div class="col-sm-10">
                       <label>Change</label>
                          <input type="hidden" name="value2" id="value2"  value="<?=$grand?>" class="form-control" min="0"  />
                          <input type="number" name="sum" id="sum" value=""class="form-control" readonly />
                        </div>
                    </div>
                    
         </div>
         <input type="hidden" name="queueID" value="<?=$queueID?>"/>
<button type="submit" name="paynow"class="btn btn-info">Pay</button>
</form>
